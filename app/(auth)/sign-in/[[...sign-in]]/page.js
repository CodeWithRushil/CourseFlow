...
export default function Page() {
  return (
    ...
    //         <Image src="https://floatui.com/logo.svg" width={150} height={150} className="mx-auto" alt="logo"/>
    ...
    <>
      <div className="text-center">
        <div className="mt-10">
          <h3 className="text-gray-800 text-xl font-bold sm:text-xl">Log in to your account</h3>
        </div>
      </div>
