...
const CreateCourse = () => {
    ...
    const generateCourseLayout = async () => {
        ...
        const basicPrompt = "Generate A Course Tutorial on Following Detail with field as Course Name, Description, Along with Chapter Name, About, Duration: Category: ";
                    ...
                    <div className="flex items-start max-w-screen-lg mx-auto">
                        <div className="w-full">
                            ...
                            <div className="mt-2 mr-4">
                                <h6 className="text-sm font-semibold text-blue-600 transition-all duration-500 ease-linear">Cateogry</h6>
                            </div>
                        </div>
                        <div className="w-full">
                            <div className="flex items-center w-full">
                            ...
                            <div className="mt-2 mr-4">
                                <h6 className={`text-sm font-semibold ${activeStep > 0 ? "text-blue-600" : "text-gray-300"} transition-all duration-500 ease-linear`}>Topic & Desc</h6>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <h6 className={`text-sm font-semibold ${activeStep > 1 ? "text-blue-600" : "text-gray-300"} transition-all duration-500 ease-linear`}>Options</h6>
                            </div>
                        </div>
                    </div>
