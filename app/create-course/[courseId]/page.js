      ...
      <div className="mt-25 mb-20 sm:mb-25 sm:mt-30 px-7 md:px-20 lg:px-50">
        ...
        {loading ? (
          ...
          <>
            ...
            <button
              className="flex items-center justify-center gap-2 mt-10 mb-10 cursor-pointer focus:outline-none text-white bg-[#155DFC] hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-500 font-semibold"
